...
public class AssignmentTwo {
    ...
    public void partSix() {
        ...
        // Create employees and rides
        Employee operator5 = new Employee("David Exporter", 33, "david@themepark.com", "E005", "Data Management");
        Ride rollerCoaster2 = new Ride("Dragon Coaster", "Roller Coaster", operator5, 5);

        // Create and add visitors to history
        System.out.println("\n--- Creating visitors and adding to ride history ---");
        Visitor[] visitors = {
                new Visitor("Emma", 24, "emma@email.com", "V101", "Premium"),
                new Visitor("Noah", 31, "noah@email.com", "V102", "Standard"),
                new Visitor("Olivia", 29, "olivia@email.com", "V103", "Premium"),
                new Visitor("Liam", 26, "liam@email.com", "V104", "Standard"),
                new Visitor("Ava", 22, "ava@email.com", "V105", "Student")
        };

        for (Visitor visitor : visitors) {
            rollerCoaster2.addVisitorToHistory(visitor);
        }
        ...
        String filename = "roller_coaster_history.csv";
        System.out.println("\n--- Exporting ride history to file: " + filename + " ---");
        rollerCoaster2.exportRideHistory(filename);

        // Verify file was created
        File file = new File(filename);
        if (file.exists()) {
            System.out.println("File verification: " + filename + " created successfully");
            System.out.println("File size: " + file.length() + " bytes");
        } else {
            System.out.println("File verification: " + filename + " was not created");
        }
    }
    ...
    public void partSeven() {
        ...
        // Create a new ride for import demonstration
        Employee operator6 = new Employee("Rachel Importer", 27, "rachel@themepark.com", "E006", "Data Management");
        Ride newRide = new Ride("New Adventure", "Adventure Ride", operator6, 4);

        // Clear any existing history to demonstrate fresh import
        System.out.println("\n--- Clearing existing ride history ---");
        newRide.clearRideHistory();
        ...
        String filename = "roller_coaster_history.csv";
        System.out.println("\n--- Importing ride history from file: " + filename + " ---");
        ...
        newRide.importRideHistory("non_existent_file.csv");
    }
}